...
namespace Visa.Universal.App.Utils
{
    public static class AccountHelper
    {
        ...
        private static readonly string _accountListPath = Path.Combine(ApplicationData.Current.LocalFolder.Path, USER_ACCOUNT_LIST_FILE_NAME);
        ...
        private static async void SaveAccountListAsync()
        {
            ...
            //todo check if jsut always create file without first part of if???
