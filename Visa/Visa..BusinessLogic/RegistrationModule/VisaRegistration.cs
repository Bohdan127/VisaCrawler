...
namespace Visa.BusinessLogic.RegistrationModule
{
    public class VisaRegistration //: IRegistration
    {
        ...
        public VisaDataSet.ClientDataRow ClientDataRow { get; set; }
            ...
            DoWorkEventArgs e)
        {
            ...
            var bBreak = CheckSiteAvailability();
            while (!bBreak)
            {
