...
namespace Visa.License.DB {
    ...
    public partial class LicenseDBDataSet : global::System.Data.DataSet {
        ...
        public partial class InstancesDataTable : global::System.Data.TypedTableBase<InstancesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public InstancesRow AddInstancesRow(string Guid, string PcName, int CustomerID) {
        ...
        public partial class InstancesRow : global::System.Data.DataRow {
            ...
            public int CustomerID {
                get {
                    try {
                        return ((int)(this[this.tableInstances.CustomerIDColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'CustomerID\' in table \'Instances\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableInstances.CustomerIDColumn] = value;
                }
            }
            ...
            public bool IsCustomerIDNull() {
                return this.IsNull(this.tableInstances.CustomerIDColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetCustomerIDNull() {
                this[this.tableInstances.CustomerIDColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Visa.License.DB.LicenseDBDataSetTableAdapters {
    ...
    public partial class InstancesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Instances] WHERE (([Guid] = @Original_Guid) AND ((@IsNull_CustomerID" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Instances] ([Guid], [PcName], [CustomerID]) VALUES (@Guid, @PcName, " +
                "@CustomerID);\r\nSELECT Guid, PcName, CustomerID FROM Instances WHERE (Guid = @Gui" +
                "d)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Instances] SET [Guid] = @Guid, [PcName] = @PcName, [CustomerID] = @CustomerID WHERE (([Guid] = @Original_Guid) AND ((@IsNull_CustomerID = 1 AND [CustomerID] IS NULL) OR ([CustomerID] = @Original_CustomerID)));
SELECT Guid, PcName, CustomerID FROM Instances WHERE (Guid = @Guid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Guid, PcName, CustomerID\r\nFROM            Instances";
